...
<div className="max-w-6xl mx-auto p-6 bg-gradient-to-b from-blue-50 to-slate-50 rounded-2xl shadow-lg relative">
  ...
  <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full">
    ...
    <div className="flex-1 max-w-md text-9xl font-bold bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent leading-none text-center p-6 whitespace-nowrap">
      {probabilityGuess}%
    </div>
  </div>
</div>
