...
const DuckPond = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gradient-to-b from-blue-50 to-slate-50 rounded-2xl shadow-lg relative">
      {/* Confetti Animation */}
      ...
      <div className="bg-gradient-to-r from-blue-50 via-white to-blue-50 rounded-2xl border-2 border-blue-200 shadow-lg p-8 mb-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full">
          {/* Class Size Section */}
          <div className="flex-1 max-w-xs text-9xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent leading-none text-center p-4">
            {classSize}
          </div>

          {/* Hint Section */}
          <div className="flex-1 relative text-center px-8 py-6 bg-white rounded-xl shadow-lg">
            <img
          ...
          {/* Probability Guess Section */}
          <div className="flex-1 max-w-sm text-9xl font-bold bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent leading-none text-center p-6 whitespace-nowrap">
            {probabilityGuess}%
          </div>
        </div>
      </div>
     ...
     <div>
       ...
       {showPrize && (
         <div className="absolute inset-0 flex items-center justify-center">
           <h2 className="text-4xl font-extrabold text-yellow-500 text-center">
